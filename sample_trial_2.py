...
class NMFTrainingThread(Thread):
    ...
    def run(self):
        ...
        # topics_1 = [ 'today', 'drink', 'day', 'good', 'sober', 'time', 'feel', 'make', 'work', 'thing', 'sleep', 'liver', 'day', 'night', 'doctor', 'body', 'feel', 'week', 'melatonin', 'coffee', 'remove', 'post', 'sake', 'delete', 'sober', 'subreddit', 'guideline', 'intoxicate', 'influence', 'lurk', 'delete', 'remove', 'day', 'month', 'torrent', 'week', 'tri', 'today', 'hit', 'make', 'congrat', 'congratulation', 'year', 'awesome', 'day', 'digit', 'great', 'happy', 'today', 'job', 'remove', 'delete', 'removed', 'stop', 'post', 'advice', 'guy', 'rock', 'slip', 'question', 'quote', 'theme', 'love', 'life', 'happy', 'thing', 'great', 'change', 'wednesday', 'good', 'meeting', 'aa', 'people', 'group', 'meet', 'smart', 'good', 'area', 'attend', 'online', 'today', 'drink', 'join', 'day', 'check', 'tomorrow', 'good', 'tonight', 'ya', 'plan', 'badge', 'request', 'link', 'reset', 'mobile', 'sidebar', 'delete', 'desktop', 'flair', 'click', 'cream', 'ice', 'chocolate', 'day', 'lol', 'morning', 'good', 'aussie', 'eat', 'enjoy', 'solicit', 'pm', 'communication', 'rstopdrinking', 'safe', 'chat', 'offer', 'helpful', 'telephone', 'skype', 'app', 'ad', 'save', 'track', 'money', 'reddit', 'quit', 'adblock', 'iphone', 'facebook', 'reply', 'update', 'post', 'hey', 'awesome', 'wow', 'love', 'great', 'hope', 'message', 'meditation', 'yoga', 'meditate', 'guide', 'app', 'practice', 'headspace', 'breath', 'mindfulness', 'minute', 'movie', 'join', 'chat', 'stopdrinkingsocial', 'official', 'weekly', 'netflix', 'ircsnoonetorg', 'gmt', 'eastern', 'chip', 'meeting', 'coin', 'aa', 'month', 'day', 'congratulation', 'congrat', 'group', 'sponsor', 'congratulation', 'congrat', 'congrats', 'awesome', 'gasp', 'bri', 'sadie', 'wonderful', 'alum', 'day', 'duplicate', 'remove', 'post', 'ddn', 'ipya', 'vpla', 'jcsd', 'originalthat', 'parentsfamily', 'aixz', 'email', 'download', 'link', 'naked', 'book', 'free', 'copy', 'mind', 'click', 'folder', 'bot', 'reddit', 'rsdquote', 'thread', 'footerif', 'contactmessagecomposetortotesmessenger', 'infortotesmessenger', 'bloop', 'bleep', 'link', 'yupme', 'crazyi', 'toi', 'andi', 'gotcha', 'blanket', 'article', 'totally', 'care', 'talk', 'test', 'delete', 'uzcea', 'uohtg', 'uem', 'testing', 'ivbn', 'ehss', 'vpmw', 'mcrg', 'game', 'play', 'gamer', 'gaming', 'video', 'playstation', 'ps', 'online', 'fallout', 'feldman', 'remove', 'wgr', 'christina', 'baldwin', 'kombucha', 'kudzu', 'pain', 'xjpfb', 'imxic', 'duxim', 'rsuicidewatch', 'remove', 'suicide', 'reach', 'care', 'aware', 'resource', 'prevention', 'listen']

        # unique_topics = list(dict.fromkeys(topics_1))

        # # Assuming each topic is a document
        # documents = [' '.join(unique_topics)]

        # # Create a custom TF-IDF vectorizer with your unique topics as vocabulary
        # tfidf_vectorizer = TfidfVectorizer(vocabulary=unique_topics)
        ...
        topics = [ 'today', 'drink', 'day', 'good', 'sober', 'time', 'feel', 'make', 'work', 'thing', 'sleep', 'liver', 'day', 'night', 'doctor', 'body', 'feel', 'week', 'melatonin', 'coffee', 'remove', 'post', 'sake', 'delete', 'sober', 'subreddit', 'guideline', 'intoxicate', 'influence', 'lurk', 'delete', 'remove', 'day', 'month', 'torrent', 'week', 'tri', 'today', 'hit', 'make', 'congrat', 'congratulation', 'year', 'awesome', 'day', 'digit', 'great', 'happy', 'today', 'job', 'remove', 'delete', 'removed', 'stop', 'post', 'advice', 'guy', 'rock', 'slip', 'question', 'quote', 'theme', 'love', 'life', 'happy', 'thing', 'great', 'change', 'wednesday', 'good', 'meeting', 'aa', 'people', 'group', 'meet', 'smart', 'good', 'area', 'attend', 'online', 'today', 'drink', 'join', 'day', 'check', 'tomorrow', 'good', 'tonight', 'ya', 'plan', 'badge', 'request', 'link', 'reset', 'mobile', 'sidebar', 'delete', 'desktop', 'flair', 'click', 'cream', 'ice', 'chocolate', 'day', 'lol', 'morning', 'good', 'aussie', 'eat', 'enjoy', 'solicit', 'pm', 'communication', 'rstopdrinking', 'safe', 'chat', 'offer', 'helpful', 'telephone', 'skype', 'app', 'ad', 'save', 'track', 'money', 'reddit', 'quit', 'adblock', 'iphone', 'facebook', 'reply', 'update', 'post', 'hey', 'awesome', 'wow', 'love', 'great', 'hope', 'message', 'meditation', 'yoga', 'meditate', 'guide', 'app', 'practice', 'headspace', 'breath', 'mindfulness', 'minute', 'movie', 'join', 'chat', 'stopdrinkingsocial', 'official', 'weekly', 'netflix', 'ircsnoonetorg', 'gmt', 'eastern', 'chip', 'meeting', 'coin', 'aa', 'month', 'day', 'congratulation', 'congrat', 'group', 'sponsor', 'congratulation', 'congrat', 'congrats', 'awesome', 'gasp', 'bri', 'sadie', 'wonderful', 'alum', 'day', 'duplicate', 'remove', 'post', 'ddn', 'ipya', 'vpla', 'jcsd', 'originalthat', 'parentsfamily', 'aixz', 'email', 'download', 'link', 'naked', 'book', 'free', 'copy', 'mind', 'click', 'folder', 'bot', 'reddit', 'rsdquote', 'thread', 'footerif', 'contactmessagecomposetortotesmessenger', 'infortotesmessenger', 'bloop', 'bleep', 'link', 'yupme', 'crazyi', 'toi', 'andi', 'gotcha', 'blanket', 'article', 'totally', 'care', 'talk', 'test', 'delete', 'uzcea', 'uohtg', 'uem', 'testing', 'ivbn', 'ehss', 'vpmw', 'mcrg', 'game', 'play', 'gamer', 'gaming', 'video', 'playstation', 'ps', 'online', 'fallout', 'feldman', 'remove', 'wgr', 'christina', 'baldwin', 'kombucha', 'kudzu', 'pain', 'xjpfb', 'imxic', 'duxim', 'rsuicidewatch', 'remove', 'suicide', 'reach', 'care', 'aware', 'resource', 'prevention', 'listen']
...
class Top2VecTrainingThread(Thread):
    ...
    def run(self):
        ...
        model = Top2Vec(texts, embedding_model="distiluse-base-multilingual-cased", embedding_batch_size=8, min_count=10, workers=-1)
